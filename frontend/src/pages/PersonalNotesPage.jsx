    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="text-xs font-semibold text-slate-500 dark:text-slate-400">
          Menampilkan <strong className="text-slate-900 dark:text-white">{filteredTimelineNotesCount(filteredNotes.length)}</strong> acuan gaji
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs border-collapse">
            <thead className="bg-slate-100 dark:bg-slate-800/80 text-slate-600 dark:text-slate-300 font-bold uppercase tracking-wider text-[11px]">
              <tr>
                <th className="px-6 py-3.5 border-b border-slate-200 dark:border-slate-700">Net Salary</th>
                <th className="px-6 py-3.5 border-b border-slate-200 dark:border-slate-700">TK0 / K0</th>
                <th className="px-6 py-3.5 border-b border-slate-200 dark:border-slate-700">K1 / K2</th>
                <th className="px-6 py-3.5 border-b border-slate-200 dark:border-slate-700 text-right">Actions</th>
              </tr>
            </thead>
              ...
              {loading ? (
                <tr>
                  <td colSpan="4" className="px-6 py-12 text-center text-slate-400">
                    Memuat data acuan gaji...
                  </td>
                </tr>
              ) : filteredNotes.length === 0 ? (
                <tr>
                  <td colSpan="4" className="px-6 py-12 text-center text-slate-400">
                    Tidak ada data acuan gaji ditemukan.
                  </td>
                </tr>
              ) : (
                filteredNotes.map((item) => (
                  <tr key={item.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      {item.tk0_k0 !== null && item.tk0_k0 !== undefined && item.tk0_k0 > 0 ? (
                    ...
                    <td className="px-6 py-4">
                      {item.k1_k2 !== null && item.k1_k2 !== undefined && item.k1_k2 > 0 ? (
